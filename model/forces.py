...
def merge_bodies(body1: Body, body2: Body) -> Optional[Body]:
    ...
    new_body.velocity = (body1.velocity * body1.mass + body2.velocity * body2.mass) / new_mass
    return new_body
...
def repulsion_forces(self, body1: Body, body2: Body) -> vec2:
    """
    ...
    overlapping_pairs = []
    self.find_overlapping_pairs(self.root, overlapping_pairs)
