...
class GPUNBodySimulation:
    ...
    def update(self):
        ...
        # Launch the custom CUDA kernel for updating positions and velocities
        update_kernel((grid_size,), (block_size,), (positions_flat, velocities_flat, forces_flat, self.masses, self.num_bodies, self.dt))
